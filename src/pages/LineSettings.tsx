  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <PageHeader
        ...
        title="LINE 串接設定"
        description="管理 Webhook 與 Channel 憑證"
        action={
      ...
      <div className="bg-white p-8 rounded-xl shadow-sm border space-y-6">
        <h3 className="text-lg font-bold border-b pb-4 flex items-center gap-2"><MessageCircle className="w-5 h-5 text-green-600" />LINE Messaging API</h3>
