...
部署前請先在 Supabase SQL Editor 執行一次 [supabase_migration_2026-08-13.sql](supabase_migration_2026-08-13.sql)（新增本次用到的欄位，可重複執行），
再到「帳號管理」頁面用現有的管理員帳號點「將我設為主帳號」，第 9、12 項才會生效。
